...
// Поле стоит под заголовком раздела, белой карточкой на тёплой подложке:
// системная полупрозрачная заливка на этом фоне не читалась.
 ...
 * экране. На устройстве она стоит справа в ряду панели вкладок.
 */
